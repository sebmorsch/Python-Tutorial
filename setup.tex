...
% Der Text der Aufgaben steht im Ordner ./pratices/tasks/aufgabenstellungen,
...
% Text mit Pfad
\newcommand{\aufgabentext}[1]{\renewcommand{\labelenumi}{\alph{enumi})}\auftitle\label{#1}\input{./practices/tasks/#1}}
% Funktion für die Lösungs-Hinweise für eine Aufgabe. Der Text
% steht analog zu den Übungsaufgaben im Ordner tasks/solutions.
\newcommand{\hinweistext}[1]{\renewcommand{\labelenumi}{\alph{enumi})}\input{./practices/solutions/#1}}
...
\newcommand{\dataset}[1]{\begin{datensatz}\label{#1}\input{./practices/datasets/#1}\end{datensatz}}
