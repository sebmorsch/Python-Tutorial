...
\newcommand{\checknextarg}[1]{\@ifnextchar\bgroup{\gobblenextarg}{ \newline \newline Die Lösungen zu den Aufgaben finden Sie im Anhang \ref{#1sol}. }}
\newcommand{\gobblenextarg}[1]{  \aufgabe{#1}\@ifnextchar\bgroup{\gobblenextarg}{ \newline \newline Die Lösungen zu den Aufgaben finden Sie im Anhang \ref{#1sol}.}}
\makeatother
