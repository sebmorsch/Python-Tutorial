...
JavaScript Object Notation (JSON) ist ein Format für den Austausch von Daten, welches unabhängig von der Programmiersprache ist. Aufgrund von Konventionen,
...
dem JSON-Format ermöglicht. Mit Hilfe des folgenden Codes binden wir das Package in das Projekt ein. 
...
werden wir bei der Ausgabe des JSON-Objekts feststellen, dass diese auf eine Zeile beschränkt ist. 
...
Mit Hilfe des \lstinline$indent$-Parameters können festlegen, ob und wie weit die Textstruktur eingerückt werden soll. 
Der \lstinline$separators$-Parameter legt die Trennzeichen fest und mit \lstinline$sort_keys=True$ wird die Ausgabe der Schlüssel lexikographisch sortiert.
