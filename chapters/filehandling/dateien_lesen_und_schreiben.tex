...
\chapter{Dateien lesen und schreiben}
...
\label{filehandling:section:zusammenfassungdateienlesenundschreiben}
...
Abschließend haben wir noch den Zugriff auf die wichtigsten Attribute, die ein \lstinline$fileObject$ besitzt, kennengelernt.