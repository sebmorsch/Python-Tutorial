...
\lstinputlisting[language=Python, linerange={1-1,4-5}]{chapters/filehandling/src/dateien_lesen_und_schreiben/FileHandlingReadWrite.py}
...
\lstinputlisting[language=Python, linerange={1-1,6-7}]{chapters/filehandling/src/dateien_lesen_und_schreiben/FileHandlingReadWrite.py}
...
\lstinputlisting[language=Python, linerange={1-1,9-13}]{chapters/filehandling/src/dateien_lesen_und_schreiben/FileHandlingReadWrite.py}
...
\lstinputlisting[language=Python, linerange={1-1,15-23}]{chapters/filehandling/src/dateien_lesen_und_schreiben/FileHandlingReadWrite.py}
...
\lstinputlisting[language=Python, linerange={1-1,25-34}]{chapters/filehandling/src/dateien_lesen_und_schreiben/FileHandlingReadWrite.py}
