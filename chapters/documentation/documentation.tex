...
Eines dieser Plattform-unabhängigen Werkzeuge mit dem Namen \textit{epydoc} wird im Folgenden genauer betrachtet. 
...
Bei dieser Analyse werden Docstrings benötigt, deren Benutzung und Einbindung noch genauer betrachtet wird.
...
Eine Dokumentation zu einer bestimmten Pyhton-Datei ist dann möglich, wenn epydoc an der selben Stelle im Dateipfad ausgeführt wird. 
