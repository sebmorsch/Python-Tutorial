...
\label{threads:subsection:synchronisierung}
...
\lstinputlisting[language=Python,firstline=3,lastline=8]{exercises/src/nebenlaufigkeit/beispiel_synchronisation_fehler.py}
...
\lstinputlisting[language=Python,firstline=10,lastline=17]{exercises/src/nebenlaufigkeit/beispiel_synchronisation_fehler.py}
...
\lstinputlisting[language=Python,firstline=19]{exercises/src/nebenlaufigkeit/beispiel_synchronisation_fehler.py}
