...
Nach dem Download des Installationsassistenten kann dieser gestartet werden und führt den Nutzer anschließend durch den Installationsprozess. Er unterscheidet sich zwischen den Betriebssystemen nur gering bis gar nicht.
...
\end{figure}
%TODO MOVE COMMON STUFF TO COMMON INSTALLATION SECTION
...
\lstinputlisting{chapters/sections/listings/comment.py} %TODO FIX LISTING (Ü and overhang)
