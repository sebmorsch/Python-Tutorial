...
Im folgenden wird die Installation an Ubuntu Version 18.04.1 LTS verdeutlicht.
Ubuntu bring von Haus aus einen Python Interpreter in der Version 3.6.6 mit.
Allerdings ist hier nicht die Standard Entwicklungsumgebung IDLE enthalten.
Diese kann über das Paket \textit{IDLE} nachinstalliert werden.
Sollte kein Python vorhanden sein kann man dies über das Terminal mit folgendem Befehl installieren.
