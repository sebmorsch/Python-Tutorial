...
In Python existiert für die Datenstruktur List keine Methode, die mit \textit{contains()} in Java oder der \textit{find()} aus C++ vergleichbar ist. Stattdessen stehen die Membership Operatoren \textit{\glqq{}in\grqq{}} oder \textit{\glqq{}not in\grqq{}} zur Verfügung, welche auf eine beliebige Sequenz oder die hier beschriebenen Collections angewendet, Auskunft darüber gibt, ob das spezifizierte Element darin enthalten ist.
...
Die Verwendung der Operatoren \textit{\glqq{} in\grqq{}} und \textit{\glqq{}not in\grqq{}} ist, wie die len-Methode, analog zur List -Datenstruktur.
...
\textbf{difference():}
Liefert ein Set, das diejenigen Elemente enthält, die ausschließlich in setX vorkommen. Alle Element, die mit denen von setY übereinstimmen, werden aus dem ersten entfernt. Alternativ ist dies auch mit der Angabe des \textit{\glqq{}-\grqq{}}Operators möglich.
...
\textbf{intersection():}
Liefert ein Set mit der Schnittmenge zweier Sets. Alternativ ist dies auch mit der Angabe des \textit{\glqq{}\&\grqq{}}-Zeichen möglich.
...
\textbf{isdisjoint():}
Gibt Auskunft darüber, ob zwei Sets eine Schnittmenge besitzen. Liefert \textit{\glqq{}True\grqq{}}, wenn kein Element des ersten Sets im zweiten enthalten ist.
