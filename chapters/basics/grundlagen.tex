...
In Abbildung \ref{fig:InstallationWindows} ist die notwendige Auswahl zu sehen. 
\begin{figure}[ht]
\centering
...
Wie bei anderen Programmiersprachen auch, stehen für Python verschiedene IDEs zur Verfügung, die in Abschnitt \ref{ides:section:ides} behandelt werden.
...
Innerhalb der Klammern muss ein String übergeben werden, eine einfache Zeichenkette. 
...
Mehr erfährt der Leser in späteren Kapiteln. Ein einfaches ''Hello-World!''-Programm benötigt in Python tatsächlich nur eine Zeile: 

\lstinputlisting[language=python, label={grundlagen:lst:HalloWorld}]{chapters/basics/src/helloworld.py}
Es handelt sich dabei um ein vollständiges Python-Programm, welches in dieser Form ausgeführt werden kann. 
Anders als bei Java oder C++ werden keinerlei Klassenkonstrukte oder main-Methoden benötigt.
\section{Übung}
...
\kontrollfrage{
\item[\kontroll] Installieren sie Python und lassen sie sich im Anschluss über \lstinline$--version$ die Version ihres Python Interpreters ausgeben. 

\tip{Über den Parameter --help können sich alle möglichen Parameter angezeigt werden.}
\item[\kontroll] Schreiben sie ihr eigenes kleines \lstinline$HalloWorld$ Programm und lassen es im Anschluss über das Terminal ausführen.
}
