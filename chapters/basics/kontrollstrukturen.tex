...
firstline=1,lastline=16]{chapters/basics/src/fehler_und_ausnahmebehandlung/ExceptionHandling.py}
...
\lstinputlisting[language=Python, linerange={1-3,20-32}]{chapters/basics/src/fehler_und_ausnahmebehandlung/ExceptionHandling.py}
...
\lstinputlisting[language=Python, linerange={1-3,36-58}]{chapters/basics/src/fehler_und_ausnahmebehandlung/ExceptionHandling.py}
...
\section {raise}
\label{kontrollstrukturen:sec:raise}
...
\lstinputlisting[language=Python, linerange={1-3,61-70}]{chapters/basics/src/fehler_und_ausnahmebehandlung/ExceptionHandling.py}
...
\lstinputlisting[language=Python, linerange={1-3,73-81}]{chapters/basics/src/fehler_und_ausnahmebehandlung/ExceptionHandling.py}
\label{kontrollstrukturen:lst:raisemitaufruf}

\section {Selbst definierte Ausnahmen}
\label{kontrollstrukturen:sec:selbstdefinierteeausnahmen}
...
\lstinputlisting[language=Python, linerange={1-3,85-97}]{chapters/basics/src/fehler_und_ausnahmebehandlung/ExceptionHandling.py}
\label{kontrollstrukturen:lst:eigeneaushamendefiniert}

\section {Zusammenfassung}
\label{kontrollstrukturen:sec:zusammenfassungfehlerundausnahmebehandlung}
