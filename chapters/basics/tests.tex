...
\label{testing:sec:BeispielTestDocTest}
...
\subsubsection*{Möglichkeiten der Teststrukturierung}
Über das Modul \lstinline$doctest$ ist es einerseits möglich, Tests direkt an den Programmcode zu hängen und über den \lstinline$docString$ der Funktion tests auszuführen.
Diese Tests werden am ende eines Moduls mit \lstinline$doctest.testmod()$ aufgerufen.
Eine weitere Möglichkeit ist über \lstinline$doctest.testfile([filename])$ separate Testdateien festzulegen.
