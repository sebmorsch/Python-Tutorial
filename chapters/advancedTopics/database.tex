...
Daten aus der SQLite Datenbank werden mit einem SELECT-Befehl ausgelesen.
...
Um einen Eintrag im Nachhinein zu ändern, kann durch den \glqq Update\grqq Befehl ein oder mehrere bestimmte Einträge geändert werden. Im Listing wird der Vorname des Mitarbeiters mit der \lstinline{MitarbeiterId = 1} auf Peter gesetzt.
\begin{lstlisting}[language=Python]
#update
...
Eine Tabelle oder einen bestimmten Mitarbeiter kann durch einen \glqq delete\grqq{}  Befehl wieder entfernt werden. In folgendem Listing\ref{database:lst:delete} werden zwei Möglichkeiten Daten aus der Datenbank zu entfernen aufgezeigt.
\begin{lstlisting}[language=Python]
#delete
