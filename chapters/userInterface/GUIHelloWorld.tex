\section{Hello World mit grafischer Benutzeroberfläche}

Um Tkinter zu initialisieren, muss ein Tk Wurzel-Element erstellt werden.
Dabei handelt es sich um ein gewöhnliches Fenster mit einer Titelleiste und anderer Dekoration,
die vom Betriebssystem bereitgestellt werden.
Generell sollte nur ein Wurzel-Element für jedes Programm erstellt werden, das auf höchster
...
Damit das Fenster mit Inhalt gefüllt werden kann müssen dem Wurzel-Element weitere
Widgets als Kinder hinzugefügt werden. Dazu wurde ein Label mit dem Namen \lstinline$label_1$ angelegt.
...
Als nächstes benötigt Tkinter die Anweisung, wie der Inhalt das Fenster angezeigt werden soll.
...
Anschließend kann das Programm wie bereits bekannt ausgeführt werden.

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{images/HelloWorldGUI.png}
	\caption{Hello World Beispiel mit grafischer Benutzeroberfläche}
	\label{fig:HelloWorldGUI}
\end{figure}

Das Programm wird nun solange ausgeführt und bleibt in der Ereignisschleife, bis das Fenster geschlossen wird.
