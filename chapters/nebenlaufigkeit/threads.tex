...
\lstinline$finally$-Block zu schreiben (vgl. Listing \ref{threads:lst:try_aquire_lock}).
...
\lstinline$with$-Statement erreicht werden (vgl. Listing \ref{threads:lst:with_aquire_lock}).
