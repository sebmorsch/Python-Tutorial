...
Im Gegensatz zu Objekte der \lstinline$Lock$-Klasse, die nie einem Thread zugeordnet werden, werden
...
Das \lstinline$RLock$ ist erst dann wieder offen, wenn \lstinline$release()$ so auf aufgerufen wurde wie
