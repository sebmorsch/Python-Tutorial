...
\randnotiz{nonlocal-Statement}
Durch \lstinline$nonlocal$ wird eine Variable auf die nächst umschließende Definition festgelegt (\ref{scopesOfVariablesAndFunctions:lst:nonlocalStatement}). 
...
\randnotiz{global-Statement}
Das Gleiche können wir mit dem globalen Gültigkeitsbereich machen, wie in \ref{scopesOfVariablesAndFunctions:lst:globalStatement} gezeigt.
