...
\randnotiz{Aufteilen von komplexen Aufgaben}
...
\kontrollfrage{
	\item[\kontroll] Was sind die Vorteile, die beim Aufteilen von komplexen in mehrere simple Aufgaben auftreten?
...
\randnotiz{Reduktion von Code-Duplikationen}
...
\randnotiz{Bessere Lesbarkeit, Erweiterbarkeit, Veränderbarkeit}
